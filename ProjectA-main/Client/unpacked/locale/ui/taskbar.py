...
window = {
	...
	(
			...
			(
				{
					...
					"images" :
					(
						"locale/ui/Mall/00.sub",
						"locale/ui/Mall/01.sub",
						"locale/ui/Mall/02.sub",
						"locale/ui/Mall/03.sub",
						"locale/ui/Mall/04.sub",
						"locale/ui/Mall/05.sub",
						"locale/ui/Mall/06.sub",
						"locale/ui/Mall/07.sub",
						"locale/ui/Mall/08.sub",
						"locale/ui/Mall/09.sub",
						"locale/ui/Mall/11.sub",
						"locale/ui/Mall/12.sub",
						"locale/ui/Mall/13.sub",
						"locale/ui/Mall/14.sub",
						"locale/ui/Mall/15.sub",
						"locale/ui/Mall/16.sub",
					)
				},
				{
					"name" : "RampageGauge2",
		...
		},
		{
			...
			"default_image_1" : ROOT + "TaskBar/antiexp_off_01.tga",
			"over_image_1" : ROOT + "TaskBar/antiexp_off_02.tga",
			"down_image_1" : ROOT + "TaskBar/antiexp_off_03.tga",
			"default_image_2" : ROOT + "TaskBar/antiexp_on_01.tga",
			"over_image_2" : ROOT + "TaskBar/antiexp_on_02.tga",
			"down_image_2" : ROOT + "TaskBar/antiexp_on_03.tga",

			"tooltip_text" : uiScriptLocale.ANTIEXP_TOOLTIP,
		},
		...
		## Button
		{
			...
			"tooltip_text" : uiScriptLocale.TASKBAR_MONEY,
