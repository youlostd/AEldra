...
LOCALE_PATH = INTRO_PATH + "select/"	#uiScriptLocale.SELECT_PATH  D:\ymir work\ui\intro\949_select\
...
window = {
	...
	(
		...
		##Character Board(Left)##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y, "width" : THINBOARD_CIRCLE_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : 305 - SELECT_BTN_GAP,
			...
			(
				...
				
				{
					...
					"x" : X_GAP, "y" : 61, "width" : THINBOARD_CIRCLE_LEFT_WIDTH, "height" : 231 - SELECT_BTN_GAP,
					"children" :
					(
						##Job Select##
						{
							...
							(
								...
								{								
									...
									"image" : INTRO_PATH + "public_intro/name/name_warrior_small.sub",
								},	
							),
						},
						{
							...
							(
								...
								{								
									...
									"x" : SMALL_NAME_X, "y" : SMALL_NAME_Y, "x_scale" : SMALL_NAME_SCALE_X, "y_scale" : SMALL_NAME_SCALE_Y,
									"image" : INTRO_PATH + "public_intro/name/name_assassin_small.sub",
								},	
							),
						},
						{
							...
							(
								...
								{								
									...
									"x" : SMALL_NAME_X, "y" : SMALL_NAME_Y, "x_scale" : SMALL_NAME_SCALE_X, "y_scale" : SMALL_NAME_SCALE_Y,
									"image" : INTRO_PATH + "public_intro/name/name_sura_small.sub",
								},	
							),
						},
						{
							...
							(
								...
								{								
									...
									"x" : SMALL_NAME_X, "y" : SMALL_NAME_Y, "x_scale" : SMALL_NAME_SCALE_X, "y_scale" : SMALL_NAME_SCALE_Y,
									"image" : INTRO_PATH + "public_intro/name/name_shaman_small.sub",
								},	
							),
						},
						#{
						...
						#			"x" : SMALL_NAME_X, "y" : SMALL_NAME_Y, "x_scale" : SMALL_NAME_SCALE_X, "y_scale" : SMALL_NAME_SCALE_Y,
						#			"image" : INTRO_PATH + "public_intro/name/name_wolfman_small.sub",
						#		},	
						#	),
						#},
					),
		...
		## Select Sex & Shape ##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y + 305 + 3 - SELECT_BTN_GAP, "width" : THINBOARD_CIRCLE_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : (Y_GAP * 2) + 48,
			"children" : 
			(
				{
