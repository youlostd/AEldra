...
INTRO_PATH = "d:/ymir work/ui/intro/"
LOCALE_PATH = INTRO_PATH + "select/"
...
window = {
	...
	(
		## BackGround##
		{
			...
			"image" : INTRO_PATH + "empire/background/empire_sinsu.sub",
		},
		{
		...
		## Shadow ##
		{
			...
			"image" : INTRO_PATH + "shadow/shadow.tga",#test.bmp",
		},

		##SelectCharList Board##
		{
			"name" : "character_board", "type" : "thinboard_gold",
			"x" : BOARD_X, "y" : BOARD_Y, "width" : THINBOARD_CIRCLE_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : 305 - SELECT_BTN_GAP,#331,
			...
			(
					...
					(
						{
							...
							"image" : INTRO_PATH + "empire/empireflag_a.sub"
						},
						{
				...
				## Select Character Button ##
				{
					...
					"x" : X_GAP, "y" : 61, "width" : THINBOARD_CIRCLE_LEFT_WIDTH, "height" : 231 - SELECT_BTN_GAP,#253,
					"children" :
					(
		...
		## Create & Delete Button ##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y + 305 + 3 - SELECT_BTN_GAP, "width" : THINBOARD_CIRCLE_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : (Y_GAP * 2) + 27,
			"children" : 
			(
				{
		...
		##Select Hair Board(Right)##
		{
			"name" : "hairselect_board", "type" : "thinboard_gold",
			"x" : SCREEN_WIDTH - BOARD_X - (THINBOARD_CIRCLE_RIGHT_WIDTH + (X_GAP * 2)), "y" : BOARD_Y + THINBOARD_GOLD_HEIGHT + 7,
			"width" : THINBOARD_CIRCLE_RIGHT_WIDTH + (X_GAP * 2) + 1, "height" : 8 + 20 + 32 + 8,

			"children" :
			(
				{
					"name" : "hairselect_title", "type" : "text",
					"x" : 0, "y" : 8,
					"horizontal_align" : "center", "text_horizontal_align" : "center",
					"text" : uiScriptLocale.PLAYER_SELECT_HAIR_TITLE,
				},
				{
					"name" : "hairselect_prev", "type" : "button",
					"x" : 35, "y" : 8 + 20 + (32 - 13) / 2,
					"default_image" : ROOT_PATH + "public_intro_btn/prev_btn_01.sub",
					"over_image" 	: ROOT_PATH + "public_intro_btn/prev_btn_02.sub",
					"down_image" 	: ROOT_PATH + "public_intro_btn/prev_btn_01.sub",
				...
				{
					"name" : "hairselect_next", "type" : "button",
					"x" : 20 + 35, "y" : 8 + 20 + (32 - 13) / 2,
				...
				{
					"name" : "hairselect_image", "type" : "image",
					"x" : 0, "y" : 8 + 20,
