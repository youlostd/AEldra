...
LOCALE_PATH = constInfo.GetCharacterWindowPath( ) # uiScriptLocale.WINDOWS_PATH
			...
			(
				...
				## Page Area
				{
					...
					(
						...
						{ 
							"name":"attackspeed_limit_btn",
							"type":"button",
							"x":3+66+40,
							"y":221+33+25+1,
							
							"default_image" : "d:/ymir work/ui/game/character/questionmark_normal.tga",
							"over_image" : "d:/ymir work/ui/game/character/questionmark_hover.tga",
							"down_image" : "d:/ymir work/ui/game/character/questionmark_down.tga",
						 },
					...
					(

						{
							...
							(
								...
								{
									"name" : "Special_Skill_Group_Btn",
									"type" : "button",

									"x" : 50 + 45,
									"y" : 2,

									"text" : localeInfo.SPECIAL_SKILL_BUTTON_TEXT,
									"text_color" : 0xFFFFE3AD,
...
if constInfo.ENABLE_NEW_EMOTES:
	window["children"][0]["children"][6]["children"][3]["y"] -= 20
	window["children"][0]["children"][6]["children"][4]["y"] -= 20
	window["children"][0]["children"][6]["children"][5]["y"] -= 20
	window["children"][0]["children"][6]["children"][5]["y_count"] = 1

	window["children"][0]["children"][6]["children"] += (
															## New Emotes
															{ "name":"New_Emotes_Bar", "type":"horizontalbar", "x":12, "y":8+150 - 20 + 63, "width":223, },
															{ "name":"New_Emotes_Bar_Text", "type":"text", "x":15, "y":10+150 - 20 + 63, "text":uiScriptLocale.NEW_EMOTES},
