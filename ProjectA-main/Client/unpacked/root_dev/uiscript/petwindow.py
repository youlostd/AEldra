...
BOARD_WIDTH = 237
BOARD_HEIGHT = 33+42+5+20+18+7+18+3
	...
	(
		{
			...
			"title" : uiScriptLocale.PET_TITLE,
					...
					(
						{
							...
							"text" : uiScriptLocale.PET_STAT1_NAME,
						},
						{
							"name" : "Stat1_Slot",
							"type" : "slotbar",
					...
					(
						{
							...
							"text" : uiScriptLocale.PET_STAT2_NAME,
						},
						{
							"name" : "Stat2_Slot",
							"type" : "slotbar",
					...
					(
						{
							...
							"text" : uiScriptLocale.PET_STAT3_NAME,
						},
						{
							"name" : "Stat3_Slot",
							"type" : "slotbar",
					...
					(
						{
							...
							"text" : uiScriptLocale.PET_STAT4_NAME,
						},
						{
							"name" : "Stat4_Slot",
							"type" : "slotbar",
